...
import * as strings from 'TextoimgWebPartStrings';
import Textoimg from './components/Textoimg';
import { ITextoimgProps } from './components/ITextoimgProps';
